<?php $__env->startSection('title'); ?> <?php echo e(__('tripmodule::trip.destination')); ?>
...
<section class="content">
    ...
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <form class="form-horizontal" action="<?php echo e(url('/admin-panel/destination')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" name="parent_id">
                            ...
                            <?php $__currentLoopData = $destinations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($dest->id); ?>"><?php echo e($dest->title); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<!-- /.tab-content -->
            ...
            <div class="box-footer">
                <a href="<?php echo e(url('/admin-panel/destination')); ?>" type="button" class="btn btn-default"><?php echo e(__('tripmodule::trip.cancel')); ?> &nbsp; <i class="fa fa-remove" aria-hidden="true"></i> </a>
