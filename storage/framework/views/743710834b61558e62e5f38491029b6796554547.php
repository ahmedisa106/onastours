        ...
        <div class="col-xs-12">
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <a href="<?php echo e(url('admin-panel/widgets/slider/create')); ?>" type="button" class="btn btn-success pull-right"><i class="fa fa-plus" aria-hidden="true"></i> &nbsp; <?php echo e(__('widgetsmodule::widgets.addnew')); ?></a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <table id="SlidersIndex" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('widgetsmodule::widgets.title')); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($item->photo): ?>
                                        <img src="<?php echo e(asset('public/images/sliders/' . $item->photo)); ?>" width="100" height="70">
                                    <?php else: ?>
                                        <p>No Photo</p>
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a title="Edit" href="<?php echo e(url('admin-panel/widgets/slider/' . $item->id . '/edit')); ?>" type="button" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                                    <?php endif; ?>
                                    
                                    <?php if(auth()->check() && auth()->user()->hasRole('superadmin')): ?>
                                    <form class="inline" action="<?php echo e(url('admin-panel/widgets/slider/' . $item->id)); ?>" method="POST">
