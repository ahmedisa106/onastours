...
<section class="content">
  ...
  <div class="box box-info">
    ...
    <?php endif; ?>
    <!-- /.box-header -->
    <form class="form-horizontal" action="<?php echo e(url('admin-panel/widgets/testimonials')); ?>/<?php echo e($monial->id); ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="box-body">
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" autocomplete="off" class="form-control"
                name="name" value="<?php echo e($monial->name); ?>" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" autocomplete="off" class="form-control" name="job_title" value="<?php echo e($monial->job_title); ?>" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea id="editor1" name="quote" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo e($monial->quote); ?></textarea>
            </div>
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            ...
            <br/>
            <img src="<?php echo e(asset('public/images/testimonials/' . $monial->photo)); ?>" width="100" height="70">
          </div>
        </div>
