    ...
    <div class="header-4-upper">
        <div class="wand-container">
            ...
            <span class="header-4-upper__social">
                <a href="<?php echo e($config['instgram']); ?>"><img src="<?php echo e(url('assets/front')); ?>/assets/images/header4upperIns.png" alt="header4ins"></a>
                <a href="<?php echo e($config['fb_link']); ?>"><img src="<?php echo e(url('assets/front')); ?>/assets/images/header4face.png" alt="face"></a>
                <a href="<?php echo e($config['tw_link']); ?>"><img src="<?php echo e(url('assets/front')); ?>/assets/images/header4twitter.png" alt="twitter"></a>
            </span>
        </div>
    </div>
