...
@section('content')
    <section class="content">
        ...
        @endforeach @endif
        <!-- /.box-header -->
            <form class="form-horizontal" action="{{url('/admin-panel/trip')}}/{{ $trip->id }}" method="POST"
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="checkbox" {{$trip->is_home_page ==1 ? 'checked' :''}} name="is_home_page">
                            </div>
...
@foreach ($activeLang as $lang)
    <script>
        $(function () {
            ...
            CKEDITOR.replace('shoort_desc' + '{{ $lang->id }}');
