        ...
        <div class="col-xs-12">
            <div class="box box-info">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4">
                        <h3>@lang('tripmodule::trip.Category')</h3>
                        @foreach ($trip->categories as $tripcategory)
                        {{ $tripcategory->title }}
                        @endforeach
                    </div>

                    <div class="col-md-4">
                        <h3>@lang('tripmodule::trip.destination')</h3>
                        @foreach ($trip->destinations as $tripdestination)
