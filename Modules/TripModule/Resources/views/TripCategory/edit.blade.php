                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="title_{{$lang->lang}}" type="text" autocomplete="off" value="{{ ValueOf($categ, $lang, 'title') }}" class="form-control" placeholder="Write Title" name="{{$lang->lang}}[title]" @if($loop->first) required @endif>
                                    </div>
                                </div>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane @if($loop->first) active @endif" id="seo{{ $lang->display_lang }}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="countKeyWords{{$lang->lang}}" autocomplete="off" type="text" class="form-control" name="{{$lang->lang}}[meta_keywords]" value="{{ ValueOf($categ, $lang, 'meta_keywords') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="slug_{{$lang->lang}}" type="text" autocomplete="off" class="form-control" name="{{$lang->lang}}[slug]" value="{{ ValueOf($categ, $lang, 'slug') }}">
                                </div>
                            </div>
