...
class TripCategoryRepository
{
    ...
    public function findSlug($slug) {
		return TripCategory::whereTranslation('slug', $slug)->first();
	}
    ...
    public function update($id, $data, $data_trans)
    {
        ...
        foreach (\LanguageHelper::getLang() as $lang) {
            ...
            if (isset($data_trans[$lang->lang]['description'])) {
                ...
                $desc = str_replace('<p>','',$data_trans[$lang->lang]['description']);
                $desc2 = str_replace('</p>','',$desc);

                $trip->translate('' . $lang->lang)->description = $desc2;
            }
