...
<section class="content">
    ...
    <div class="box box-info">
        ...
        @endforeach @endif
        <!-- /.box-header -->
        <form class="form-horizontal" action="{{url('/admin-panel/transfers')}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input class="form-control" type="text" autocomplete="off" name="sort_order">
                </div>
