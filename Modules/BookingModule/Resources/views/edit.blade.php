                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="number" autocomplete="off" class="form-control" value="{{ $book->kids_number }}" name="name" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="title">{{__('bookingmodule::book.notes')}}:</label>
                        <div class="col-sm-6">
                            <input type="text" autocomplete="off" class="form-control" value="{{ $book->note }}" name="name" required>
                        </div>
                    </div>
                </div>
