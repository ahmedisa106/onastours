...
<section class="content">
    ...
    <div class="box box-info">
        ...
        @endforeach @endif
        <!-- /.box-header -->
        <form class="form-horizontal" action="{{url('admin-panel/widgets/hours')}}/{{ $hour->id }}" method="POST">
            {{ method_field('put') }}
            {{ csrf_field() }}
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" autocomplete="off" value="{{ $hour->day }}" class="form-control" name="day" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" autocomplete="off" value="{{ $hour->from }}" class="form-control" name="from" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" autocomplete="off" value="{{ $hour->to }}" class="form-control" name="to" required>
                    </div>
                </div>
