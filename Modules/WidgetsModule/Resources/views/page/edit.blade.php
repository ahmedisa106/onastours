...
<section class="content">
  ...
  <div class="box box-info">
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{ url('admin-panel/widgets/page') }}/{{ $page->id }}" method="POST" enctype="multipart/form-data">
      {{ method_field('put') }}
      {{ csrf_field() }}
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            ...
            @if ($page->photo)
                <br>
                <img src="{{asset('public/images/pages/' . $page->photo)}}" width="100" height="70">
            @else
                <br>
