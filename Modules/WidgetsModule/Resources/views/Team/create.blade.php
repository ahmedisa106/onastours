...
<section class="content">
  ...
  <div class="box box-info">
    ...
    @endif
    <!-- /.box-header -->
    <form class="form-horizontal" action="{{url('admin-panel/widgets/team')}}" method="POST" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <div class="box-body">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" class="form-control" name="{{$lang->lang}}[name]" @if($loop->first) required @endif>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" autocomplete="off" class="form-control" name="{{$lang->lang}}[job_title]" @if($loop->first) required @endif>
                  </div>
                </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" autocomplete="off" class="form-control" name="experience">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" autocomplete="off" class="form-control" placeholder="+96..." name="phone">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" autocomplete="off" class="form-control" name="twitter">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" autocomplete="off" class="form-control" name="skype">
          </div>
        </div>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane @if($loop->first) active @endif" id="seo{{ $lang->display_lang }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <textarea class="form-control" name="{{ $lang->lang}}[meta_desc]" cols="15" rows="3"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    {{-- Meta Keywords --}}
