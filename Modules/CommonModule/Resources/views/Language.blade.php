                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-lg-3">
                                                @foreach ($langs as $lang)
                                                    ...
                                                    &nbsp;
                                                    <label><input type="radio" name="{{ $lang->lang }}Activate" value="0" @if($lang->lang == 'en' ) checked @endif @if($lang->lang == 'ar' ) disabled @endif> {{ __('commonmodule::main.deactivate') }}</label>
                                                    <hr>
                                                @endforeach
                                            </div>
                                        </div>
